...
<head>
  ...
  <body>
<header>
  <div class="main_list col-md-4"><img src="../images/bandrooms/btn_navbar.png"/></div>
  <div class="title_home  col-md-5"><p class="title">場地列表</p></div> <!--教師列表/樂器列表/場地列表-->
  <div class="lil_member  col-md-3">
    <blockquote>
      <blockquote>
        <p class="align-content-md-center"><img src="../images/bandrooms/btn_lil_member.png"/></p>
      </blockquote>
    </blockquote>
  </div>
 </header>
  ...
  <div class="LIST col-md-8">
    ...
    @foreach ($bandrooms as $bandroom)
        ...
        <a href="../images/bandrooms/{{$bandroom->image}}">
            <img class="listimg" src="../images/bandrooms/{{$bandroom->image}}"/>
        </a>
             <p class="LIST_content col-lg-3">
                <p>
                 名稱：{{$bandroom->name}}<br>
                 建議：{{$bandroom->people}}人<br>
            <a href="../bandroom_list/{{$bandroom->id}}">more...</a>
            </p>
        </div>
